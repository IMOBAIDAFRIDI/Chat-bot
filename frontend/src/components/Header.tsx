...
import { Sun, Moon, PanelLeft, Sparkles, Download, Zap, RefreshCw } from "lucide-react";
...
export const Header: React.FC<HeaderProps> = ({ onToggleSidebar, onExportChat, onNewChat }) => {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-slate-200/80 dark:border-chat-border-dark/80 bg-white/80 dark:bg-chat-bg-dark/80 px-4 sm:px-6 backdrop-blur-xl transition-all">
      ...
      <div className="flex items-center gap-2.5">
        ...
        <div className="hidden md:flex items-center gap-2 text-xs font-semibold text-emerald-600 dark:text-emerald-400 bg-emerald-500/10 px-3 py-1.5 rounded-full border border-emerald-500/20">
